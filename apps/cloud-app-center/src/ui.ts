...
<body>
  ...
  <main>
    ...
    <section class="view" id="deploy">
      <div class="page-head"><div><p class="eyebrow">Install Once · Deploy Anytime</p><h1>安装一次，以后一句话部署。</h1><p>把 EZdeploy Skill 和长期 Key 配置给 Codex、WorkBuddy 或其他编码 Agent。</p></div><button class="primary" id="create">生成长期部署 Key</button></div>
